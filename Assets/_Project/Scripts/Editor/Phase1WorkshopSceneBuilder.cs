...
{
    /// <summary>
    /// Builds the Phase 1 Workshop scene: a PlayerProgress bootstrap (persists across
    /// scenes) and the WorkshopController UI wired to the seeded tech tree and Tier-0
    /// parts. Requires Phase1DataSeeder to have been run first. See the headless
    ...
    public static class Phase1WorkshopSceneBuilder
    {
        ...
        public static void BuildScene()
        {
            ...
            workshop.missileEngine = Load<MissileEngineDefinition>("Assets/_Project/Data/Missiles/Engine_SolidRocket_Basic.asset");
            workshop.missileSeeker = Load<SeekerDefinition>("Assets/_Project/Data/Missiles/Seeker_IR_Basic.asset");
            workshop.missilePayload = Load<MissilePayloadDefinition>("Assets/_Project/Data/Missiles/Payload_HEFrag_Small.asset");
